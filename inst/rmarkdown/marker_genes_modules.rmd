...
for (sample in samples){
  filt.matrix <- Read10X_h5(paste0(in_dir, sample, "/outs/filtered_feature_bc_matrix.h5"), use.names = T)
  raw.matrix <- Read10X_h5(paste0(in_dir, sample, "/outs/raw_feature_bc_matrix.h5"), use.names = T)
