...
tibble::as_tibble(unique(scrna.markers)) %>% dplyr::arrange(p_val_adj) -> scrna.markers
...
final_df <- data.frame(           "cluster"     = scrna.markers$cluster,
                                  ...
                                  "MGI_ID" = paste0("<a  href='https://www.informatics.jax.org/quicksearch/summary?queryType=exactPhrase&query=",scrna.markers$geneID,"'>", scrna.markers$geneID,"</a>"))
