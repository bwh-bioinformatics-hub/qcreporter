...
```{r Mitochondrial Percentage Plot message=FALSE}
# mito
...
```{r Ribo Percentage Plot message=FALSE}
# ribo
...
```{r Visualize the number UMIs/transcripts per cell message=FALSE}
...
### genes per cell 
```{r Genes Per Cell message=FALSE}
...
```{r rna_Elbow_Plot message=FALSE}
...
### UMAP - Resolutions
```{r rna_UMAP_Resolutions_Plot message=FALSE}
...
<a  id="mgt"></a> 
```{r Marker_Gene_Table message=FALSE}
...
```{r Customer Markers, Feature Plot, Dot Plot message=FALSE}
